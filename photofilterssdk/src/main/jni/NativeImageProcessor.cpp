...
JNIEXPORT jintArray
Java_com_zomato_photofilters_imageprocessors_NativeImageProcessor_doBrightness(JNIEnv * env,jobject thiz,jintArray pixels, jint value, jint width, jint height){
jint* pixelsBuff = getPointerArray(env, pixels);
...
JNIEXPORT jintArray
Java_com_zomato_photofilters_imageprocessors_NativeImageProcessor_doContrast(JNIEnv *env, jobject thiz, jintArray pixels, jfloat value, jint width, jint height){
jint* pixelsBuff = getPointerArray(env, pixels);
...
JNIEXPORT jintArray
Java_com_zomato_photofilters_imageprocessors_NativeImageProcessor_doColorOverlay(JNIEnv *env, jobject thiz, jintArray pixels, jint depth, jfloat red, jfloat green, jfloat blue, jint width, jint height) {
jint* pixelsBuff = getPointerArray(env, pixels);
...
JNIEXPORT jintArray
Java_com_zomato_photofilters_imageprocessors_NativeImageProcessor_doSaturation(JNIEnv *env, jobject thiz, jintArray pixels, float level, jint width, jint height) {
jint* pixelsBuff = getPointerArray(env, pixels);
